...
import co.segundaEva.frontend.clave.Clave;
...
public class UsuarioManagedBean implements Serializable {
    ...
    public void registrar() {
        try {
            ...
            //Enviar Correo
            setAsunto("Bienvenido al servicio nacional de aprendizaje SENA");
            setMensaje(" Su usuario es el numero de cedula la cual no se envia por motivos de seguridad Su contraseña es: "+usuario.getClave());
